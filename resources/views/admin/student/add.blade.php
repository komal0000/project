           ...
           <form action="{{route('admin.student.add')}}" id="add-student" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <label for="level_id"> <input  type="checkbox" value="1" class="no_change" data-id="level_id" > {{env('iscollage',false)?"Program":"Level"}}</label>
                    ...
                    <div class="col-md-3">
                        ...
                        <label for="section_id"> <input  type="checkbox" value="1" class="no_change" data-id="section_id" > {{env('iscollage',false)?"Semester":"Section"}}</label>
                    ...
                    <div class="col-md-3">
                        <label for="aadhar_no">{{ env('citizen', 'Citizenship No') }}</label>
                    ...
                    <div class="col-md-3">
                        <label for="tehsil"><input type="checkbox" value="1" class="no_change" data-id="tehsil" > {{ env('municipality', 'Municipality') }}</label>
                    ...
                    <div class="col-md-3">
                        <label for="father_aadhar_no">Father's {{ env('citizen', 'Citizenship No') }}</label>
                    ...
                    <div class="col-md-3">
                        <label for="mother_aadhar_no">Mother's {{ env('citizen', 'Citizenship No') }}</label>
                    ...
                    <div class="col-md-3">
                        <label for="gaurdian_aadhar_no">Gaurdian's {{ env('citizen', 'Citizenship No') }}</label>
